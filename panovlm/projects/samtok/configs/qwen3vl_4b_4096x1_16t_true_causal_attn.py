...
work_dir = "work_dirs/qwen3vl_4b_4096x1_16t_true_causal_attn_debug_data_v1"
...
standard_dataset = dict(
    ...
    data_args=dict(
        model_type="qwen3vl",
        dataset_use="MASK_GENERATION_EarthReason%100,MASK_GENERATION_LaSeRS%100,MASK_GENERATION_RefsegRS%100,MASK_GENERATION_RISBench%100",
