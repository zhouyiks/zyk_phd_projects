...
#                          PART 1  Settings                           #
#######################################################################
qwen3vl_path = "Qwen/Qwen3-VL-4B-MT-1024x2"
vqsam2_pretrained_pth = "pretrained_weights/rs_mask_tokenizer_1024x2.pth"
sam2_path = "pretrained_weights/sam2.1_hiera_large.pt"
pretrained_pth = None

work_dir = "work_dirs/qwen3vl_4b_rs"
...
standard_dataset = dict(
    ...
    data_args=dict(
        model_type="qwen3vl",
        dataset_use="mask_generation_panoseg%100",
