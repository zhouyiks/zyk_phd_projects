...
def main():
    ...
    state = torch.load("./checkpoints_extract/rs_vq_sam2_4096x1_4tokens_false_causal_attn.pth", map_location="cpu")
    vq_sam2.load_state_dict(state)

    sam2_image_processor = DirectResize(1024)

    temp_save_root = "./temp_data_4token_false_causal_attn/RISBench"
    if not os.path.exists(temp_save_root):
        os.makedirs(temp_save_root)
    dataset_name = "RISBench"
    ...
    txt_path = "./data/RISBench_dataset/output_phrase_train.txt"
