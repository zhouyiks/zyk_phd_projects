...
def metric():
    from projects.samtok.datasets.eval_data.utils import REFER, Summary, AverageMeter, intersectionAndUnionGPU, master_only
    ...
    for json_file in os.listdir('./temp_save/earthreason'):
        with open(os.path.join('./temp_save/earthreason', json_file), 'r') as f:
