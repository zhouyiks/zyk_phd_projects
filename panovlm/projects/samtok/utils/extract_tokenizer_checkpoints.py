...
def main():
    ...
    for pth_file in os.listdir("./checkpoints"):
        if 'vq_sam2_256x8_8tokens_true_causal_attn.pth' == pth_file:
            pth_path = os.path.join("./checkpoints", pth_file)
            pretrained_state_dict = guess_load_checkpoint(pth_path)
            ...
            torch.save(pretrained_state_dict_new, os.path.join("./checkpoints_extract", pth_file))
    exit(0)
