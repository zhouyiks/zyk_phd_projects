...
from projects.llava_sam2.datasets import CoCoPanoSegDataset, ERPRegionCaptionDataset, ERPRefSegDataset, ERPGCGDataset
...
pretrained_pth = "/media/home/zhouyikang/vlm_projects/pano-vlm-mask2former/work_dirs/egovlm_qwen2_5vl_3b_backup/iter_88000.pth"
num_m2f_queries = 200
...
erp_gcg_dataset = dict(
    type=ERPGCGDataset,
    image_folder="/media/nfs/datasets/ML1_team/Insta360PanoStruct/PanoImgStruct/PanoImgStruct_V6_20231106_youtube_with_insta_owned/images",
    data_path="/media/home/zhouyikang/datasets/Ego360_GCG_Caption_train",
    tokenizer=tokenizer,
    max_length=max_length,
    repeats=1,
    special_tokens=special_tokens,
...
train_dataset = dict(
    type=ConcatDataset, datasets=[
        ...
        # erp_single_region_caption_dataset, erp_refseg_dataset, erp_gcg_dataset,
        # erp_single_region_caption_dataset, erp_refseg_dataset, erp_gcg_dataset,
        # erp_single_region_caption_dataset, erp_refseg_dataset, erp_gcg_dataset,
        # erp_single_region_caption_dataset, erp_refseg_dataset, erp_gcg_dataset,
