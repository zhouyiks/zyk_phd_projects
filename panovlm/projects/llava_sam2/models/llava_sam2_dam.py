...
class VideoLLaVASAMDAMModel(LisaModel):
    def __init__(self,
                 mllm,
                 tokenizer,
                 loss_mask=None,
        ...
        # disable_torch_init()
        self.dam_captioner = DescribeAnythingModel(
...
class VideoLLaVASAMDAMModel_zero3(VideoLLaVASAMDAMModel):
    def __init__(self,
                 mllm,
                 tokenizer,
                 grounding_encoder,
        ...
        super(VideoLLaVASAMDAMModel_zero3, self).__init__(
            mllm=mllm,
            tokenizer=tokenizer,
