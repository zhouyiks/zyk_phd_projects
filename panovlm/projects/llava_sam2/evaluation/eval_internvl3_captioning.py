...
def main():
    ...
    eval_results_save_root = "/media/home/zhouyikang/datasets/Ego360_Entity_RefSeg_val/eval_results/internvl3/captioning"
    ...
    for item in tqdm.tqdm(left_task_list):
        ...
        pixel_values = load_image(contour_image_pil, max_num=12).to(torch.bfloat16).cuda()
        question = '<image>\nThis is a ERP image. Give me a detail caption of the entity inside the cyan-colored contours.'
