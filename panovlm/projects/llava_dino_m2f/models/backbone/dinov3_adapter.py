...
class DINOv3_Adapter(nn.Module):
    ...
    def forward(self, x):
        ...
        # Final Norm
        c1_dtype = c1.dtype
        # f1 = self.norm1(c1.to(self.norm1.weight.dtype))
        # f2 = self.norm2(c2.to(self.norm2.weight.dtype))
        # f3 = self.norm3(c3.to(self.norm3.weight.dtype))
        # f4 = self.norm4(c4.to(self.norm4.weight.dtype))
