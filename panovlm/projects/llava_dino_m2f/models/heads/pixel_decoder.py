...
from projects.llava_dino_m2f.models.ms_deform_attn.batch_norm import get_norm
from projects.llava_dino_m2f.models.ms_deform_attn.position_encoding import PositionEmbeddingSine
from projects.llava_dino_m2f.models.ms_deform_attn.transformer import _get_clones, _get_activation_fn
from projects.llava_dino_m2f.models.ms_deform_attn.ms_deform_attn import MSDeformAttn
...
class MSDeformAttnTransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, pos, reference_points, spatial_shapes, level_start_index, padding_mask=None):
        # self attention
        src2 = self.self_attn(
            self.with_pos_embed(src, pos).to(self.self_attn.sampling_offsets.weight.dtype), reference_points, src, 
