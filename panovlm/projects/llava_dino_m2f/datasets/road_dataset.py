...
class SemSegDataset(Dataset):
    ...
    def prepare_data(self, index):
        ...
        for cat_id in unique_class_ids_in_image:
            ...
            if sem_mask.ndim == 3 and sem_mask.shape[2] == 1:
                ...
                try:
                    ...
                    print(self.id_2_class_name)
                    print(cat_id)
                    print(data_dict['image_file'])
                    exit(0)
        ...
        # output_image.save(f'semseg_{image_name}.jpg')
        # exit(0)
...
class CHN6CUGSemSegDataset(SemSegDataset):
    def __init__(self,
        ...
        super().__init__(
            ...
            dinov3_input_mean=dinov3_input_mean,
            dinov3_input_std=dinov3_input_std,
        )
...
class OEMSemSegDataset(SemSegDataset):
    def __init__(self,
        ...
        self.id_2_class_name = {id: class_name for id, class_name in zip(class_ids, class_names)}
        self.background_id = [0, 1, 2, 3, 5, 8]
