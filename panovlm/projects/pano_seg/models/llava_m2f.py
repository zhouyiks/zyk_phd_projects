...
class VideoLLaVAM2FModel(LisaModel):
    def __init__(self,
                 mllm,
                 tokenizer,
                 loss_mask=None,
        ...
        decoder_layers = ['transformer_module', 'class_embed.', 'logit_scale']

        # freeze mask2former
        # for n, p in self.mask2former.named_parameters():
...
class VideoLLaVASAMModel_zero3(VideoLLaVAM2FModel):
    def __init__(self,
                 mllm,
                 tokenizer,
                 grounding_encoder,
